...
export const isProcessInSuccessState = <TProcessId extends ProcessIdType>(process: IReducerStateProcessInfo<TProcessId>, processIdToCheck: TProcessId, prevProcessWasInProgress: boolean): TripleBooleanResult => {
    if (!process ||
        !processIdToCheck ||
